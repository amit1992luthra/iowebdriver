...
describe("TS001_CreateAnAccountForOldCustomerWithShippingAddress", function () {
    it('TS001_CreateAnAccountForOldCustomerWithShippingAddress', () => {
        //console.log(argv.countryName);
        ...
        signUpPage.clickOnProvideShippingAddressRadioButton();
        ...
        accountSubmittedPage.verifyAccountRequestSubmittedText(testData.common.trueStatus);
    });
});
